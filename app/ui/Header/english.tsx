...
export default function HeaderEn() {
    ...
    const navTabs = [
        { href: '#how-it-works', title: 'How does it work' },
        { href: '#advantages', title: 'Advantages' },
        { href: '#feedback-solution', title: 'Feedback solution' },
        { href: '#pay-by-qr', title: 'Order and pay by QR' },
    ].map((navTab) => { return (
    ...
    return (
        <header className={styles.header}>
            <div className={styles.container}>
                ...
                <a className={styles.switchLanguageButton}
                    href="/">
